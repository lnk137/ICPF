...
const fetchBlackAreaData = async () => {
  ...
  try {
    ...
    console.log("@@@",typeof blackRatio.value); // 打印数据类型
    console.log("@@@",typeof blackArea.value); // 打印数据类型
    console.log("@@@",typeof matrix_flow_depth.value); // 打印数据类型
    console.log("@@@",typeof priority_flow_percentage.value); // 打印数据类型
    console.log("@@@",typeof priority_staining_area.value); // 打印数据类型
    console.log("@@@",typeof maximum_staining_depth.value); // 打印数据类型
    console.log("@@@",typeof length_index.value); // 打印数据类型
